...
VALUES
    ...
    ('22222222-2222-2222-2222-222222222222', 'C & Assembly: The Exploit Developer''s Core', 'Low-level exploit development', 'Dive deep into C and Assembly to understand memory corruption and write exploits.', 'advanced', 12, 800, 4.9, 6, 'linear-gradient(135deg, #f093fb 0%, #f5576c 100%)', 'c', false, 2, '{"Python for Offensive Security"}', NOW(), NOW()),
...
INSERT INTO achievements (id, name, description, icon, xp_reward, criteria_type, criteria_threshold, created_at, updated_at)
VALUES
...
VALUES
    ('hhhhhhhh-hhhh-hhhh-hhhh-hhhhhhhhhhhh', 'supabase_user_123', 'test@example.com', 'Test User', 'https://avatar.com/test', 'I love hacking!', 'London', 'https://example.com', 'testuser', 'testuser', 0, 0, NULL, 0, 0, NULL, NOW(), NOW());
...
VALUES
    ('hhhhhhhh-hhhh-hhhh-hhhh-hhhhhhhhhhhh', 'dark', 'en', true, true, true, true, true, true, false, NOW(), NOW());