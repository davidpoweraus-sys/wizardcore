-- Seed data for WizardCore - Fixed version
...
INSERT INTO achievements (id, achievement_name, description, icon, xp_reward, criteria_type, criteria_threshold, created_at, updated_at)
VALUES
...
VALUES
    ('hhhhhhhh-hhhh-hhhh-hhhh-hhhhhhhhhhhh', '00000000-0000-0000-0000-000000000001', 'test@example.com', 'Test User', 'https://avatar.com/test', 'I love hacking!', 'London', 'https://example.com', 'testuser', 'testuser', 0, 0, NULL, 0, 0, NULL, NOW(), NOW());
